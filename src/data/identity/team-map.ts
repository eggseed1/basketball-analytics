 ...
 *
 * Rule: provider numeric IDs are namespaced. ESPN `25` ≠ BDL `25`.
...
/** Opaque namespaced key: `espn:25`, `bdl:25`. */
...
export type CanonicalTeam = {
  ...
  abbr: string;
  displayName: string;
  providerIds: Partial<Record<"espn" | "bdl", string>>;
};
 ...
 * bare numbers are interpreted as ESPN/canonical (existing DRBL convention).
 */
