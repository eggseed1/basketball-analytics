...
export const LEARN_CONCEPTS: LearnConcept[] = [
  ...
  },
  {
    ...
    category: "impact",
    tooltip:
      "Realized attributed point residual above R1 over actual season exposure — accounting value, not ability.",
    showTooltip: true,
    learnSlug: "drbl",
  ...
  {
    id: "r1_win_eq",
    aliases: ["r1_win_equivalents", "r1wineq", "win_equivalents"],
    label: "R1 Win Equivalents",
    shortName: "R1 WinEq",
    category: "impact",
    tooltip:
      "R1 Points converted with a frozen points-per-win factor. Not WAR and not roster-replacement causality.",
    showTooltip: true,
    learnSlug: "drbl",
