...
export const LEARN_CONCEPTS: LearnConcept[] = [
  ...
  },
  {
    ...
    category: "impact",
    tooltip:
      "Validated ability rate vs a role-matched R1 reference (per 100 appearances). Canonical DRBL ranking statistic — not DARKO or WAR.",
    showTooltip: true,
    learnSlug: "drbl",
    relatedIds: ["r1_points", "r1_win_eq", "drbl_o", "drbl_d", "darko"],
    seeInAction: [
  ...
  },
  {
    ...
    category: "impact",
    tooltip:
      "Underlying point-equivalent attribution above R1 — accounting / research. Wins Above R1 is the preferred public display of the same ordering.",
    showTooltip: true,
    learnSlug: "drbl",
  ...
  },
  {
    ...
    category: "impact",
    tooltip:
      "Realized season value in win-equivalent units (R1 Points ÷ frozen P1). Not traditional WAR — R1 is a contextual role-matched reference.",
    showTooltip: true,
    learnSlug: "drbl",
    relatedIds: ["drbl", "r1_points"],
  },
  {
    id: "drbl_o",
    aliases: ["drblo", "drbl-o"],
    label: "DRBL-O",
    shortName: "DRBL-O",
    category: "impact",
    tooltip: "Offensive split of validated DRBL ability — not a substitute for DRBL/100.",
    showTooltip: true,
    learnSlug: "drbl",
    relatedIds: ["drbl", "drbl_d"],
  },
  {
    id: "drbl_d",
    aliases: ["drbld", "drbl-d"],
    label: "DRBL-D",
    shortName: "DRBL-D",
    category: "impact",
    tooltip: "Defensive split of validated DRBL ability — not a substitute for DRBL/100.",
    showTooltip: true,
    learnSlug: "drbl",
    relatedIds: ["drbl", "drbl_o"],
  },
  {
    id: "drbl_p",
    ...
    category: "impact",
    tooltip:
      "Diagnostic possession component. Does not sum with LN and B into DRBL/100.",
    showTooltip: true,
    learnSlug: "drbl",
    relatedIds: ["drbl", "drbl_ln", "drbl_b"],
  },
  {
    id: "drbl_ln",
    ...
    category: "impact",
    tooltip:
      "Diagnostic lineup-context component. Does not sum with P and B into DRBL/100.",
    showTooltip: true,
    learnSlug: "drbl",
  ...
  },
  {
    ...
    category: "impact",
    tooltip:
      "Diagnostic behavior/shot-decision component. Does not sum with P and LN into DRBL/100.",
    showTooltip: true,
    learnSlug: "drbl",
